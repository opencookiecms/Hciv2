...
public class Followsadapter extends RecyclerView.Adapter<Followsadapter.ProfileHolder> {

    ArrayList<Subscribefollow> followsadapter;
    public static final String FUSERNAME = "FUSERNAME";

    public Followsadapter(ArrayList<Subscribefollow> followsadapter){
        this.followsadapter= followsadapter;
    }

    @NonNull
    @Override
    public Followsadapter.ProfileHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.ff_card,viewGroup,false);
        return new ProfileHolder(view);
    }

    @Override
    public void onBindViewHolder(final Followsadapter.ProfileHolder profileHolder, int position) {
    ...
    public class ProfileHolder extends RecyclerView.ViewHolder{
        ...
        SharedPreferences preferenceses;
        Context context;
        Intent intent;
