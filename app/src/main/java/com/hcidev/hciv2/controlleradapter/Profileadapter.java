...
public class Profileadapter extends RecyclerView.Adapter<Profileadapter.ProfileHolder> {
    ...
    public  Profileadapter(ArrayList<Note> noteadapter){
    ...
    public Profileadapter.ProfileHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mynote_card,viewGroup,false);
        return new ProfileHolder(view);
    }

    @Override
    public void onBindViewHolder(final Profileadapter.ProfileHolder profileHolder, int position) {
...
//
         ...
         profileHolder.deletebutton.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(final View v) {

                 Apiservice apiservice = Servehandler.getRetrofit().create(Apiservice.class);
                 Call<Note> call = apiservice.setDelete(notes.getNote_id());
                 call.enqueue(new Callback<Note>() {
                     ...
                     public void onResponse(Call<Note> call, Response<Note> response) {
                         if(response.isSuccessful()){
                             ...
                             Toast.makeText(v.getContext(),"Fail to delete" + response.code(),Toast.LENGTH_LONG).show();
                         }
                     }
    ...
    public class ProfileHolder extends RecyclerView.ViewHolder{
        ...
        public ProfileHolder(View profileview){
            ...
            deletebutton = profileview.findViewById(R.id.deleteButton);
